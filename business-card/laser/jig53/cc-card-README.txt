...
=======================================
Blank    : 86 x 53 mm  (laser ablates the surface -> bright silver)
Machine  : Bambu H2C, 40W laser, Bambu Suite

FILES
  cc-card-ENGRAVE.png  <- IMPORT THIS. Fits the 86 x 53mm card. Black = engrave->silver.
...
BAMBU SUITE (manual fallback)
  ...
  3. Size to the blank: 86 x 53 mm. Wipe the blank clean first.
