...
- AI Receptionist — a bilingual (English/Spanish) voice agent that answers every call 24/7, books jobs, and texts the owner each lead. Pricing is custom. There is a LIVE demo line visitors can call to hear it: ${DEMO_LINE}.
...
HOW IT WORKS: Every project gets a live preview before you pay. Fixed-scope, fixed-price — quoted up front, no hourly surprises. For the auto/collision vertical there's a done-for-you "$2,500/mo Front Desk + Growth System" (AI receptionist + reviews + status texts + Google/Maps + site).

GUARDRAILS:
- NEVER invent prices, timelines, or features beyond the list above. If asked for a price not listed (e.g. a custom app, hardware, or the AI receptionist), say it's quoted per project and offer to connect them.
...
export const CC_FALLBACK: { match: RegExp; reply: string }[] = [
  {
    ...
    reply:
      "Here's the quick version: custom websites are $1,500 (Starter), $2,500 (Pro), or $4,500+ (Scale). Local SEO / Google Maps is $199 setup + $149/mo. Apps, custom software, and the AI receptionist are quoted per project. Want me to have the team put together a quote? Drop your name, email, and what you're after.",
  },
  {
    match: /(receptionist|\bphone\b|answering|voicemail|missed call|answer my)/i,
    reply: `Our AI receptionist answers every call 24/7 in English and Spanish, books the job, and texts you each lead. Best way to get it: call the live demo and talk to it yourself — ${DEMO_LINE}. Want the team to set one up for your business?`,
  },
  {
